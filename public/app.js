...
},{"./is-function":63,"./is-object":64,"./request-base":65,"./response-base":66,"./should-retry":67,"component-emitter":28}],63:[function(require,module,exports){
/**
...
},{"./update-events.js":71,"bel":26,"morphdom":57}],71:[function(require,module,exports){
module.exports = [
...
var el = yo(_templateObject, lang.bind(null, 'es'), translate.message('spanish'), lang.bind(null, 'en-US'), translate.message('english'), translate.message('language'));
...
},{"../translate":87,"yo-yo":70}],73:[function(require,module,exports){
'use strict';
...
},{"../translate":87,"empty-element":29,"yo-yo":70}],74:[function(require,module,exports){
'use strict';
...
function loadPicturesAxios(ctx, next) {
	...
	axios.get('/api/pictures') // Hacemos la petición a la ruta de la que deseamos obtener una respuesta
...
},{"../header":73,"./template":75,"axios":1,"empty-element":29,"page":59,"title":69}],75:[function(require,module,exports){
'use strict';

var _templateObject = _taggedTemplateLiteral(['<div class="conatiner timeline">\n\t\t\t\t\t<div class="row">\n\t\t\t\t\t\t<div class="col s12 m10 offset-m1 l8 offset-l2 center-align">\n\t\t\t\t\t\t\t<form enctype="multipart/form-data" class="form-upload" id="form-upload" onsubmit=', '>\n\t\t\t\t\t\t\t\t<div id="fileName" class="fileUpload btn btn-flat cyan">\n\t\t\t\t\t\t\t\t\t<span> <i class="small material-icons">input</i>', '</span>\n\t\t\t\t\t\t\t\t\t<input name="picture" id="file" type="file" class="upload" onchange=', '/>\n\t\t\t\t\t\t\t\t</div> \n\t\t\t\t\t\t\t\t<button id="btnUpload" type="submit" class="btn btn-flat cyan hide">', '</button>\n\t\t\t\t\t\t\t\t<button id="btnCancel" tpye="button" class="btn btn-flat red hide" onclick=', '><i class="small material-icons">delete</i></button>\n\t\t\t\t\t\t\t</form>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class="row">\n\t\t\t\t\t\t<div class="col s12 m10 offset-m1 l6 offset-l3">\n\t\t\t\t\t\t\t', '\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n  \t\t\t\t</div>'], ['<div class="conatiner timeline">\n\t\t\t\t\t<div class="row">\n\t\t\t\t\t\t<div class="col s12 m10 offset-m1 l8 offset-l2 center-align">\n\t\t\t\t\t\t\t<form enctype="multipart/form-data" class="form-upload" id="form-upload" onsubmit=', '>\n\t\t\t\t\t\t\t\t<div id="fileName" class="fileUpload btn btn-flat cyan">\n\t\t\t\t\t\t\t\t\t<span> <i class="small material-icons">input</i>', '</span>\n\t\t\t\t\t\t\t\t\t<input name="picture" id="file" type="file" class="upload" onchange=', '/>\n\t\t\t\t\t\t\t\t</div> \n\t\t\t\t\t\t\t\t<button id="btnUpload" type="submit" class="btn btn-flat cyan hide">', '</button>\n\t\t\t\t\t\t\t\t<button id="btnCancel" tpye="button" class="btn btn-flat red hide" onclick=', '><i class="small material-icons">delete</i></button>\n\t\t\t\t\t\t\t</form>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class="row">\n\t\t\t\t\t\t<div class="col s12 m10 offset-m1 l6 offset-l3">\n\t\t\t\t\t\t\t', '\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n  \t\t\t\t</div>']);
...
},{"../layout":78,"../picture-card":80,"../translate":87,"superagent":62,"yo-yo":70}],76:[function(require,module,exports){
'use strict';
...
},{"./footer":72,"./homepage":74,"./signin":81,"./signup":83,"./user":88,"page":59}],77:[function(require,module,exports){
'use strict';
...
console.log('Exportando modulo Layout');

},{"yo-yo":70}],79:[function(require,module,exports){
'use strict';

var _templateObject = _taggedTemplateLiteral(['<div class="col s12 m3 l3 picture-card-mini">\n\t\t\t\t<img src="user.picture" id="', '" class="picture-card-min-image"/>\n\t\t\t\t\n\n\t\t\t\t<div class="overlay-hover">\n\t\t\t\t\t<div class="filtered-likes">30 likes</div>\n\t\t\t\t</div>\n\t\t\t</div>'], ['<div class="col s12 m3 l3 picture-card-mini">\n\t\t\t\t<img src="user.picture" id="', '" class="picture-card-min-image"/>\n\t\t\t\t\n\n\t\t\t\t<div class="overlay-hover">\n\t\t\t\t\t<div class="filtered-likes">30 likes</div>\n\t\t\t\t</div>\n\t\t\t</div>']);
...
module.exports = function templatePCM(user) {
	...
	var el = yo(_templateObject, id);

	return el;
};

},{"yo-yo":70}],80:[function(require,module,exports){
'use strict';

var _templateObject = _taggedTemplateLiteral(['<div class="card ', ' ', '">\n\t\t\t\t\t\t\t    \n\t\t\t\t\t\t\t    <div class="card-image">\n\t\t\t\t\t\t\t      <img class="activator" src="', '">\n\t\t\t\t\t\t\t    </div>\n\t\t\t\t\t\t\t    \n\t\t\t\t\t\t\t    <div class="card-content">\n\t\t\t\t\t\t\t      <a href="/', '" class="card-title">\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t<img src="', '" class="avatar"/>\n\t\t\t\t\t\t\t\t\t<span class="username">', '</span>\t\n\t\t\t\t\t\t\t      </a>\n\t\t\t\t\t\t\t      \n\t\t\t\t\t\t\t      <small class="right time">', '</small>\n\t\t\t\t\t\t\t      \n\t\t\t\t\t\t\t      <p> \n\t\t\t\t\t\t\t\t\t<a class="left" href="#" onclick=', '><img src="heart2.png" class="likes-ico heart1"/></a>\n\t\t\t\t\t\t\t\t\t<a class="left" href="#" onclick=', '><img src="heart.png" class="likes-ico heart2"/></a>\n\t\t\t\t\t\t\t\t\t<span class="left likes"> ', '</span>\n\t\t\t\t\t\t\t      </p>\n\t\t\t\t\t\t\t    </div>\n\n\t\t\t\t\t\t    </div>'], ['<div class="card ', ' ', '">\n\t\t\t\t\t\t\t    \n\t\t\t\t\t\t\t    <div class="card-image">\n\t\t\t\t\t\t\t      <img class="activator" src="', '">\n\t\t\t\t\t\t\t    </div>\n\t\t\t\t\t\t\t    \n\t\t\t\t\t\t\t    <div class="card-content">\n\t\t\t\t\t\t\t      <a href="/', '" class="card-title">\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t<img src="', '" class="avatar"/>\n\t\t\t\t\t\t\t\t\t<span class="username">', '</span>\t\n\t\t\t\t\t\t\t      </a>\n\t\t\t\t\t\t\t      \n\t\t\t\t\t\t\t      <small class="right time">', '</small>\n\t\t\t\t\t\t\t      \n\t\t\t\t\t\t\t      <p> \n\t\t\t\t\t\t\t\t\t<a class="left" href="#" onclick=', '><img src="heart2.png" class="likes-ico heart1"/></a>\n\t\t\t\t\t\t\t\t\t<a class="left" href="#" onclick=', '><img src="heart.png" class="likes-ico heart2"/></a>\n\t\t\t\t\t\t\t\t\t<span class="left likes"> ', '</span>\n\t\t\t\t\t\t\t      </p>\n\t\t\t\t\t\t\t    </div>\n\n\t\t\t\t\t\t    </div>']);
...
module.exports = function pictureCard(pic) {
	...
	function render(picture) {
		...
		return yo(_templateObject, picture.liked ? 'liked' : '', console.log(picture.liked), picture.url, picture.user.username, picture.user.avatar, picture.user.username, translate.date.format(picture.createdAt), like.bind(null, true), like.bind(null, false), translate.message('likes', { likes: picture.likes }));
	}
...
},{"../translate":87,"yo-yo":70}],81:[function(require,module,exports){
'use strict';
...
},{"./template":82,"empty-element":29,"page":59,"title":69}],82:[function(require,module,exports){
'use strict';
...
var signinForm = yo(_templateObject, translate.message('signup.facebook'), translate.message('signup.text'), translate.message('username'), translate.message('password'), translate.message('signin.text'), translate.message('sigin.not-have-account'), translate.message('signup.call-to-action'));

console.log('Exportando template signin');
module.exports = landing(signinForm);

},{"../landing":77,"../translate":87,"yo-yo":70}],83:[function(require,module,exports){
'use strict';
...
},{"./template":84,"empty-element":29,"page":59,"title":69}],84:[function(require,module,exports){
'use strict';
...
var signupForm = yo(_templateObject, translate.message('signup.subheading'), translate.message('signup.facebook'), translate.message('signup.text'), translate.message('email'), translate.message('fullname'), translate.message('username'), translate.message('password'), translate.message('signup.call-to-action'), translate.message('signup.have-account'), translate.message('signin.call-to-action'));
console.log('Exportando template signup');
module.exports = landing(signupForm);

},{"../landing":77,"../translate":87,"yo-yo":70}],85:[function(require,module,exports){
'use strict';
...
module.exports = {
		...
		'signin.text': 'Signin',
		'sigin.not-have-account': 'Don\'t have an account?',
		'language': 'Language',
...
},{"./en-US":85,"./es":86,"intl":51,"intl-messageformat":36,"intl-relativeformat":45,"intl-relativeformat/dist/locale-data/en.js":43,"intl-relativeformat/dist/locale-data/es.js":44,"intl/locale-data/jsonp/en.js":53,"intl/locale-data/jsonp/es.js":54}],88:[function(require,module,exports){
'use strict';
...
page('/:username', header, loadUser, function (ctx, next) {
	//if(err) console.log(err);
	title('Platz\xA1gram - ' + ctx.params.username + ' ');
	var main = document.getElementById('main-container');
...
module.exports = function templateUser(user) {
	var el = yo(_templateObject, user.avatar, user.username, user.pictures.map(function (pict) {
		return yo(_templateObject2, pict.src, pict.likes);
	}));

	return layout(el);
};

},{"../layout":78,"../picture-card-mini":79,"yo-yo":70}]},{},[76]);
